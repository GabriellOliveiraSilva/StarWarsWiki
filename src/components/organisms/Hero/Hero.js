...
export const Hero = ({ item, type, typeOfObj }) => {
  switch (type) {
    case "detail":
      return (
        <StylesHero>
    ...
    default:
      return (
        <StylesHero>
          <StylesHeroImageBackground source={{ uri: item.image }}>
            <StylesHeroLinearGradiaent
              colors={[colors.dark, "transparent", colors.dark]}
            >
              <CustomLogo source={ImperialLogo} width={24} height={24} />
              <Tag text={"Filme"} mt={214}>
                {" "}
              </Tag>
              <CustomText
                text={"Episódio I"}
              ...
              <StylesButtonsView>
                <IconButton
                  ...
                  iconName={"add-circle-outline"}
                ></IconButton>
                <PlayButton text={"Assistir"} iconName={"play"}></PlayButton>
                <IconButton
                  text={"Saiba Mais"}
                  iconName={"information-circle-outline"}
                ></IconButton>
